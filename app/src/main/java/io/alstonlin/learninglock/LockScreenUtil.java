...
public class LockScreenUtil {
     ...
     */
    public static void unlock(Context context, FrameLayout attach){
        try {
     ...
     */
    public static void lock(Context context, FrameLayout attach){
        ...
        layoutInflater.inflate(R.layout.activity_lockscreen, (ViewGroup) attach);
    }
